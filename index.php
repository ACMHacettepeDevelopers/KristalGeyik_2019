...
<head>
    ...
    <title>Hacettepe Kristal Geyik Ödülleri | 2019</title>
        ...
        <div id="tmSideBar" class="col-xl-3 col-lg-4 col-md-12 col-sm-12 sidebar">
            ...
            <div class="inner">
                <nav id="tmMainNav" class="tm-main-nav">
                    <ul>
                        <li>
                            <a id="list-logo-item" href="#intros" class="scrolly" data-bg-img="constructive_bg_01.jpg" data-page="#tm-section-1">
                                <div id="logo" data-page="#tm-section-1"></div>
                            </a>
                        </li>
                        <li>
                            <a href="#intros" id="tmNavLink1" class="scrolly active" data-bg-img="constructive_bg_01.jpg" data-page="#tm-section-1">
        ...
        <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content">
            ...
            <section id="tm-section-1" class="tm-section">
                <div class="ml-auto">
                    ...
                    <!--&lt;!&ndash; data-nav-link holds the ID of nav item, which means this link should behave the same as that nav item  &ndash;&gt;-->
                </div>
            </section>
                    ...
                    <div id="accordion">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tm-img-container">
                                        <div class="tm-img-slider">
                                            <a href="img/winners/bilim/alper_celik.png" class="tm-slider-img">
                                                <img src="img/winners/bilim/alper_celik.png" alt="Image" class="img-fluid">
                                                <p>Alper Çelik</p>
                                            </a>
                                            <a href="img/winners/bilim/ergi_deniz_ozsoy.png" class="tm-slider-img">
                                                <img src="img/winners/bilim/ergi_deniz_ozsoy.png" alt="Image" class="img-fluid">
                                                <p>Deniz Özsoy</p>
                                            </a>
                                            <a href="img/winners/bilim/mete_atature.png" class="tm-slider-img">
                                                <img src="img/winners/bilim/mete_atature.png" alt="Image" class="img-fluid">
                                                <p>Mete Atatüre</p>
                                            </a>
                                            <a href="img/winners/bilim/nurettin_noyan.png" class="tm-slider-img">
                                                <img src="img/winners/bilim/nurettin_noyan.png" alt="Image" class="img-fluid">
                                                <p>Nurettin Noyan</p>
                                            </a>
                                            <a href="img/winners/bilim/tayfun.png" class="tm-slider-img">
                                                <img src="img/winners/bilim/tayfun.png" alt="Image" class="img-fluid">
                                                <p>Tayfun Aybek</p>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="card-body">
                                    <div class="tm-img-container">
                                        <div class="tm-img-slider">
                                            <a href="img/winners/kultur_sanat/ali_lidar.png" class="tm-slider-img">
                                                <img src="img/winners/kultur_sanat/ali_lidar.png" alt="Image" class="img-fluid">
                                                <p>Ali Lidar</p>
                                            </a>
                                            <a href="img/winners/kultur_sanat/babala_tv.png" class="tm-slider-img">
                                                <img src="img/winners/kultur_sanat/babala_tv.png" alt="Image" class="img-fluid">
                                                <p>Babala TV</p>
                                            </a>
                                            <a href="img/winners/kultur_sanat/demet.png" class="tm-slider-img">
                                                <img src="img/winners/kultur_sanat/demet.png" alt="Image" class="img-fluid">
                                                <p>Demet Evgar</p>
                                            </a>
                                            <a href="img/winners/kultur_sanat/elif_yılmaz.png" class="tm-slider-img">
                                                <img src="img/winners/kultur_sanat/elif_yılmaz.png" alt="Image" class="img-fluid">
                                                <p>Elif Yılmaz</p>
                                            </a>
                                            ...
                                            <a href="img/winners/kultur_sanat/zakkum.png" class="tm-slider-img">
                                                <img src="img/winners/kultur_sanat/zakkum.png" alt="Image" class="img-fluid">
                                                <p>Zakkum</p>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                <div class="card-body">
                                    <div class="tm-img-container">
                                        <div class="tm-img-slider">
                                            <a href="img/winners/muhendislik/anova.png" class="tm-slider-img">
                                                <img src="img/winners/muhendislik/anova.png" alt="Image" class="img-fluid">
                                                <p>Anova</p>
                                            </a>
                                            <a href="img/winners/muhendislik/bilisim.png" class="tm-slider-img">
                                                <img src="img/winners/muhendislik/bilisim.png" alt="Image" class="img-fluid">
                                                <p>Bilişim</p>
                                            </a>
                                            <a href="img/winners/muhendislik/bosch.png" class="tm-slider-img">
                                                <img src="img/winners/muhendislik/bosch.png" alt="Image" class="img-fluid">
                                                <p>Bosch</p>
                                            </a>
                                            <a href="img/winners/muhendislik/dsm.png" class="tm-slider-img">
                                                <img src="img/winners/muhendislik/dsm.png" alt="Image" class="img-fluid">
                                                <p>DSM</p>
                                            </a>
                                            ...
                                            <a href="img/winners/muhendislik/toyota.png" class="tm-slider-img">
                                                <img src="img/winners/muhendislik/toyota.png" alt="Image" class="img-fluid">
                                                <p>Toyota</p>
                                            </a>
                                            <a href="img/winners/muhendislik/vestel.png" class="tm-slider-img">
                                                <img src="img/winners/muhendislik/vestel.png" alt="Image" class="img-fluid">
                                                <p>Vestel</p>
                                            </a>
                                            <a href="img/winners/muhendislik/yda.png" class="tm-slider-img">
                                                <img src="img/winners/muhendislik/yda.png" alt="Image" class="img-fluid">
                                                <p>YDA</p>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                            <div class="card-body">
                                <div class="tm-img-container">
                                    <div class="tm-img-slider">
                                        <a href="img/winners/yonetim_finans/ey.png" class="tm-slider-img">
                                            <img src="img/winners/yonetim_finans/ey.png" alt="Image" class="img-fluid">
                                            <p>EY</p>
                                        </a>
                                        <a href="img/winners/yonetim_finans/gittigidiyor.png" class="tm-slider-img">
                                            <img src="img/winners/yonetim_finans/gittigidiyor.png" alt="Image" class="img-fluid">
                                            <p>Gittigidiyor</p>
                                        </a>
                                        <a href="img/winners/yonetim_finans/icaked.png" class="tm-slider-img">
                                            <img src="img/winners/yonetim_finans/icaked.png" alt="Image" class="img-fluid">
                                            <p>Icaked</p>
                                        </a>
                                        <a href="img/winners/yonetim_finans/koc.png" class="tm-slider-img">
                                            <img src="img/winners/yonetim_finans/koc.png" alt="Image" class="img-fluid">
                                            <p>Koç</p>
                                        </a>
                                        <a href="img/winners/yonetim_finans/mavi.png" class="tm-slider-img">
                                            <img src="img/winners/yonetim_finans/mavi.png" alt="Image" class="img-fluid">
                                            <p>Mavi</p>
                                        </a>
                                        <a href="img/winners/yonetim_finans/sarar.png" class="tm-slider-img">
                                            <img src="img/winners/yonetim_finans/sarar.png" alt="Image" class="img-fluid">
                                            <p>Sarar</p>
                                        </a>
                                        <a href="img/winners/yonetim_finans/vestel.png" class="tm-slider-img">
                                            <img src="img/winners/yonetim_finans/vestel.png" alt="Image" class="img-fluid">
                                            <p>Vestel</p>
                                        </a>
                                        <a href="img/winners/yonetim_finans/yves_rocher.png" class="tm-slider-img">
                                            <img src="img/winners/yonetim_finans/yves_rocher.png" alt="Image" class="img-fluid">
                                            <p>Yves Rocher</p>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            <label for="xiaomi" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#xiaomi">
                                                    <img src="img/candidates/muhendislik/elektronik/xiaomi.png" alt="xiaomi">
                                                    <span>Xiaomi <input name="electronic" value="xiaomi" id="xiaomi" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="turksat" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#turksat">
                                                    <img src="img/candidates/muhendislik/elektronik/turksat.png" alt="turksat">
                                                    <span>Türksat <input name="electronic" value="turksat" id="turksat" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="ntm" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#ntm">
                                                    <img src="img/candidates/muhendislik/elektronik/ntm.png" alt="ntm">
                                                    <span>NTM <input name="electronic" value="ntm" id="ntm" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="kingston" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#kingston">
                                                    <img src="img/candidates/muhendislik/elektronik/kingston.png" alt="kingston">
                                                    <span>Kingston <input name="electronic" value="kingston" id="kingston" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="logitech" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#logitech">
                                                    <img src="img/candidates/muhendislik/elektronik/logitech.png" alt="logitech">
                                                    <span>Logitech <input name="electronic" value="logitech" id="logitech" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="vestel-elec" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#vestel-elec">
                                                    <img src="img/candidates/muhendislik/elektronik/vestel.png" alt="vestel">
                                                    <span>Vestel Elektronik <input name="electronic" value="vestel-elec" id="vestel-elec" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="asus" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#asus">
                                                    <img src="img/candidates/muhendislik/elektronik/asus.png" alt="asus">
                                                    <span>Asus <input name="electronic" value="asus" id="asus" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="bosch" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#bosch">
                                                    <img src="img/candidates/muhendislik/elektronik/bosch.png" alt="bosch">
                                                    <span>Bosch <input name="electronic" value="bosch" id="bosch" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
                            ...
                            <div class="row">
                                <ul>
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            ...
                                            <label for="garanti" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#garanti">
                                                    <img src="img/candidates/yonetim_finans/bankacilik/garanti.png" alt="garanti">
                                                    <span>Garanti Bankası<input name="bankacilik" value="garanti" id="garanti" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="qnb_finansbank" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#qnb_finansbank">
                                                    <img src="img/candidates/yonetim_finans/bankacilik/qnb_finansbank.png" alt="qnb_finansbank">
                                                    <span>QNB Finansbank<input name="bankacilik" value="qnb_finansbank" id="qnb_finansbank" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
                                    ...
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            <label for="agt" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#agt">
                                                    <img src="img/candidates/yonetim_finans/dayanikli_tuketim/agt.png" alt="agt">
                                                    <span>AGT<input name="dayanikli_tuketim" value="agt" id="agt" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="bosch-dayanikli" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#bosch">
                                                    <img src="img/candidates/yonetim_finans/dayanikli_tuketim/bosch.png" alt="bosch">
                                                    <span>Bosch<input name="dayanikli_tuketim" value="bosch" id="bosch-dayanikli" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="vestel" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#vestel">
                                                    <img src="img/candidates/yonetim_finans/dayanikli_tuketim/vestel.png" alt="vestel">
                                                    <span>Vestel<input name="dayanikli_tuketim" value="vestel" id="vestel" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="xiaomi-dayanikli" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#xiaomi">
                                                    <img src="img/candidates/yonetim_finans/dayanikli_tuketim/xiaomi.png" alt="xiaomi">
                                                    <span>Xiaomi<input name="dayanikli_tuketim" value="xiaomi" id="xiaomi-dayanikli" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
                                    ...
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            <label for="ey" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#ey">
                                                    <img src="img/candidates/yonetim_finans/denetim_danismanlik/ey.png" alt="ey">
                                                    <span>EY<input name="denetim_danismanlik" value="ey" id="ey" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="kpmg" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#kpmg">
                                                    <img src="img/candidates/yonetim_finans/denetim_danismanlik/kpmg.png" alt="kpmg">
                                                    <span>KPMG<input name="denetim_danismanlik" value="kpmg" id="kpmg" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="pwc" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#pwc">
                                                    <img src="img/candidates/yonetim_finans/denetim_danismanlik/pwc.png" alt="pwc">
                                                    <span>PWC<input name="denetim_danismanlik" value="pwc" id="pwc" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                    ...
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            <label for="biletall" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#biletall">
                                                    <img src="img/candidates/yonetim_finans/e_ticaret/biletall.png" alt="biletall">
                                                    <span>Biletall<input name="e_ticaret" value="biletall" id="biletall" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="bynogame" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#bynogame">
                                                    <img src="img/candidates/yonetim_finans/e_ticaret/bynogame.png" alt="bynogame">
                                                    <span>Bynogame<input name="e_ticaret" value="bynogame" id="bynogame" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="enuygun" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#enuygun">
                                                    <img src="img/candidates/yonetim_finans/e_ticaret/enuygun.png" alt="enuygun">
                                                    <span>Enuygun<input name="e_ticaret" value="enuygun" id="enuygun" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="gittigidiyor" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#gittigidiyor">
                                                    <img src="img/candidates/yonetim_finans/e_ticaret/gittigidiyor.png" alt="gittigidiyor">
                                                    <span>Gittigidiyor<input name="e_ticaret" value="gittigidiyor" id="gittigidiyor" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="letgo" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#letgo">
                                                    <img src="img/candidates/yonetim_finans/e_ticaret/letgo.png" alt="letgo">
                                                    <span>Letgo<input name="e_ticaret" value="letgo" id="letgo" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="morhipo" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#morhipo">
                                                    <img src="img/candidates/yonetim_finans/e_ticaret/morhipo.png" alt="morhipo">
                                                    <span>Morhipo<input name="e_ticaret" value="morhipo" id="morhipo" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="obilet" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#obilet">
                                                    <img src="img/candidates/yonetim_finans/e_ticaret/obilet.png" alt="obilet">
                                                    <span>Obilet<input name="e_ticaret" value="obilet" id="obilet" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="turna" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#turna">
                                                    <img src="img/candidates/yonetim_finans/e_ticaret/turna.png" alt="turna">
                                                    <span>Turna<input name="e_ticaret" value="turna" id="turna" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
                                    ...
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            <label for="avva" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#avva">
                                                    <img src="img/candidates/yonetim_finans/giyim/avva.png" alt="avva">
                                                    <span>Avva<input name="giyim" value="avva" id="avva" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="colins" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#colins">
                                                    <img src="img/candidates/yonetim_finans/giyim/colins.png" alt="colins">
                                                    <span>Colin's<input name="giyim" value="colins" id="colins" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="ipekyol" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#ipekyol">
                                                    <img src="img/candidates/yonetim_finans/giyim/ipekyol.png" alt="ipekyol">
                                                    <span>İpekyol<input name="giyim" value="ipekyol" id="ipekyol" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="kigili" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#kigili">
                                                    <img src="img/candidates/yonetim_finans/giyim/kigili.png" alt="kigili">
                                                    <span>Kiğılı<input name="giyim" value="kigili" id="kigili" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="sarar" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#sarar">
                                                    <img src="img/candidates/yonetim_finans/giyim/sarar.png" alt="sarar">
                                                    <span>Sarar<input name="giyim" value="sarar" id="sarar" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="under_armour" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#under_armour">
                                                    <img src="img/candidates/yonetim_finans/giyim/under_armour.png" alt="under_armour">
                                                    <span>Under Armour<input name="giyim" value="under_armour" id="under_armour" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
                                    ...
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            <label for="allianz_group" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#allianz_group">
                                                    <img src="img/candidates/yonetim_finans/grup_sirketler/allianz_group.png" alt="allianz_group">
                                                    <span>Allianz Group<input name="grup_sirketler" value="allianz_group" id="allianz_group" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="arkas_holding" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#arkas_holding">
                                                    <img src="img/candidates/yonetim_finans/grup_sirketler/arkas_holding.png" alt="arkas_holding">
                                                    <span>Arkas Holding<input name="grup_sirketler" value="arkas_holding" id="arkas_holding" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="boyner_grup" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#boyner_grup">
                                                    <img src="img/candidates/yonetim_finans/grup_sirketler/boyner_grup.png" alt="boyner_grup">
                                                    <span>Boyner Grup<input name="grup_sirketler" value="boyner_grup" id="boyner_grup" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="dogus_grubu" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#dogus_grubu">
                                                    <img src="img/candidates/yonetim_finans/grup_sirketler/dogus_grubu.png" alt="dogus_grubu">
                                                    <span>Doğuş Grubu<input name="grup_sirketler" value="dogus_grubu" id="dogus_grubu" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="koc_holding" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#koc_holding">
                                                    <img src="img/candidates/yonetim_finans/grup_sirketler/koc_holding.png" alt="koc_holding">
                                                    <span>Koç Holding<input name="grup_sirketler" value="koc_holding" id="koc_holding" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
                                    ...
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            ...
                                            <label for="nestle-hizli" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#nestle">
                                                    <img src="img/candidates/yonetim_finans/hizli_tuketim/nestle.png" alt="nestle">
                                                    <span>Nestle<input name="hizli_tuketim" value="nestle" id="nestle-hizli" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="unilever" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#unilever">
                                                    <img src="img/candidates/yonetim_finans/hizli_tuketim/unilever.png" alt="unilever">
                                                    <span>Unilever<input name="hizli_tuketim" value="unilever" id="unilever" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
                                    ...
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            <label for="gratis" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#gratis">
                                                    <img src="img/candidates/yonetim_finans/kozmetik_kisisel_bakim/gratis.png" alt="gratis">
                                                    <span>Gratis<input name="kozmetik_kisisel_bakim" value="gratis" id="gratis" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="mumuso" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#mumuso">
                                                    <img src="img/candidates/yonetim_finans/kozmetik_kisisel_bakim/mumuso.png" alt="mumuso">
                                                    <span>Mumuso<input name="kozmetik_kisisel_bakim" value="mumuso" id="mumuso" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            ...
                                            <label for="raen" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#raen">
                                                    <img src="img/candidates/yonetim_finans/kozmetik_kisisel_bakim/raen.png" alt="raen">
                                                    <span>Raen<input name="kozmetik_kisisel_bakim" value="raen" id="raen" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
                                    ...
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            <label for="arkas_lojistik" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#arkas_lojistik">
                                                    <img src="img/candidates/yonetim_finans/lojistik/arkas_lojistik.png" alt="arkas_lojistik">
                                                    <span>Arkas Lojistik<input name="lojistik" value="arkas_lojistik" id="arkas_lojistik" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="omsan_lojistik" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#omsan_lojistik">
                                                    <img src="img/candidates/yonetim_finans/lojistik/omsan_lojistik.png" alt="omsan_lojistik">
                                                    <span>Omsan Lojistik<input name="lojistik" value="omsan_lojistik" id="omsan_lojistik" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            <label for="ptt" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#ptt">
                                                    <img src="img/candidates/yonetim_finans/lojistik/ptt.png" alt="ptt">
                                                    <span>PTT<input name="lojistik" value="ptt" id="ptt" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
                                    ...
                                    <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            <label for="boyner_buyuk_magazacilik" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#boyner_buyuk_magazacilik">
                                                    <img src="img/candidates/yonetim_finans/pazarlama_reklam/boyner_buyuk_magazacilik.png" alt="boyner_buyuk_magazacilik">
                                                    <span>Boyner<input name="pazarlama_reklam" value="boyner_buyuk_magazacilik" id="boyner_buyuk_magazacilik" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                            ...
                                            <label for="turna-pazarlama" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#turna">
                                                    <img src="img/candidates/yonetim_finans/pazarlama_reklam/turna.png" alt="turna">
                                                    <span>Turna<input name="pazarlama_reklam" value="turna" id="turna-pazarlama" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
                                    ...
                                    <!-- <li class="quiz_block_body_list_item">
                                        ...
                                        <div class="quiz_block_body_list_item_content row">
                                            <label for="turkcell" class="col-md-3 col-sm-4">
                                                <div class="quiz_block_body_list_item_content_block" data-class=".group_1" data-id="#turkcell">
                                                    <img src="img/candidates/yonetim_finans/telekomunikasyon/turkcell.png" alt="turkcell">
                                                    <span>Turkcell<input name="telekomunikasyon" value="turkcell" id="turkcell" type="radio" class="btnGr"></span>
                                                </div>
                                            </label>
                                        </div>
                                        <hr>
