            ...
            <div id="tmSideBar" class="col-xl-3 col-lg-4 col-md-12 col-sm-12 sidebar" style="height:100% !important;">
                ...
                <div class="inner">
                    <nav id="tmMainNav" class="tm-main-nav">
                        <ul>
                            <li>
                                <a id="list-logo-item" href="index.php" class="scrolly" data-bg-img="constructive_bg_01.jpg">
                                    <div id="logo" data-page="#tm-section-1"></div>
                                </a>
                            </li>
                            <li>
                                <a href="#contact" class="scrolly active" data-bg-img="constructive_bg_01.jpg" data-page="#tm-section-1">
                                    <i class="fas fa-comments tm-nav-fa-icon"></i>
                                    <span>Oy Ver</span>
                                </a>
                            </li>
                            <li style="display:none;">
                                <a href="#intros" id="tmNavLink1" class="scrolly" data-bg-img="constructive_bg_01.jpg" data-page="#tm-section-1">
