<!DOCTYPE html>
        ...
        <head>
            ...
            <style>
                ...
                .login-container {
                background: rgba(222, 184, 86, 0.43);
                padding: 12px;
                }
                ...
                .login input {
                background-color: rgba(3, 0, 0, 0.22);  
        ...
        <div style="padding-bottom: 100px">
            ...
            <div class="login">
                <form class="login-container" class="login-form">
                    <p>Ad Soyad<br><input type="text" name="name" id="" placeholder="Ad Soyad"></p>
                    <p>Öğrenci No<br><input type="text" name="student-id" id="" placeholder="Ögrenci Numarası"></p>
